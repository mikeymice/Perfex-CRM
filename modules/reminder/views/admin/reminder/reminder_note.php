...
<div class="media sales-note-wrapper">
    ...
    <div class="media-body">
        ...
        <?php if (has_permission('supply_chain', '', 'order_notes_delete')) { ?>   
    ...
    <?php } ?>
        ...
        <div class="text-right">
            <button type="button" class="btn btn-default" onclick="toggle_edit_note(<?php echo $note['id']; ?>);return false;"><?php echo _l('supply_chain_cancel'); ?></button>
